...
function YatzyGame(gameID,name,diceCount){
    ...
    <fieldset>
      <legend>Configure Game:</legend>
       ...
       <a href = "html/help.html">
         <input type = "button" value = "Game Rules">
       </a>
      </div>
    </fieldset>
    </form>`;
  ...
  * ******************************************************************************** */
  ...
  <input type="text" name="gameID" value="${this.gameID}" style="display:none" required minlength="1" maxlength="30">
    ...
    <input type = "button" value = "Back to start" onclick = "location.href = 'http://http://127.0.0.1:3000/'"></input>
    <a href = "html/help.html">
         <input type = "button" value = "Game Rules">
       </a>
    </fieldset>
  ...
  this.helperURLbutton = function(refURL, tagTitle) {
    return `<a href="${refURL}">${tagTitle}</a>`
  }
